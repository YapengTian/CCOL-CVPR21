...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', dest='out_dir', type=str, default='/home/cxu-serve/p1/ytian21/dat/AVSS_data/MUSIC_dataset/data/frames')
    parser.add_argument('--video_path', dest='video_path', type=str, default='/home/cxu-serve/p1/ytian21/dat/AVSS_data/MUSIC_dataset/videos/solo')
